<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect :select-type="selectType" :only-content="onlyContent" :ratings="ratings" @ratingtypeSelect="ratingtypeSelect" @toggleContent="toggleContent"></ratingselect>
